...
export const B2bBackgroundBox = /*@__PURE__*/createReactComponent<JSX.B2bBackgroundBox, HTMLB2bBackgroundBoxElement>('b2b-background-box');
...
export const B2bDatePickerHeader = /*@__PURE__*/createReactComponent<JSX.B2bDatePickerHeader, HTMLB2bDatePickerHeaderElement>('b2b-date-picker-header');
export const B2bDatePickerMonths = /*@__PURE__*/createReactComponent<JSX.B2bDatePickerMonths, HTMLB2bDatePickerMonthsElement>('b2b-date-picker-months');
export const B2bDatePickerYears = /*@__PURE__*/createReactComponent<JSX.B2bDatePickerYears, HTMLB2bDatePickerYearsElement>('b2b-date-picker-years');
export const B2bDropdown = /*@__PURE__*/createReactComponent<JSX.B2bDropdown, HTMLB2bDropdownElement>('b2b-dropdown');
export const B2bFlyoutMenu = /*@__PURE__*/createReactComponent<JSX.B2bFlyoutMenu, HTMLB2bFlyoutMenuElement>('b2b-flyout-menu');
export const B2bFlyoutMenuOption = /*@__PURE__*/createReactComponent<JSX.B2bFlyoutMenuOption, HTMLB2bFlyoutMenuOptionElement>('b2b-flyout-menu-option');
...
export const B2bIcon50 = /*@__PURE__*/createReactComponent<JSX.B2bIcon50, HTMLB2bIcon50Element>('b2b-icon-50');
...
export const B2bInputList = /*@__PURE__*/createReactComponent<JSX.B2bInputList, HTMLB2bInputListElement>('b2b-input-list');
export const B2bInputListOption = /*@__PURE__*/createReactComponent<JSX.B2bInputListOption, HTMLB2bInputListOptionElement>('b2b-input-list-option');
export const B2bLabel = /*@__PURE__*/createReactComponent<JSX.B2bLabel, HTMLB2bLabelElement>('b2b-label');
export const B2bModal = /*@__PURE__*/createReactComponent<JSX.B2bModal, HTMLB2bModalElement>('b2b-modal');
export const B2bMultiselectDropdown = /*@__PURE__*/createReactComponent<JSX.B2bMultiselectDropdown, HTMLB2bMultiselectDropdownElement>('b2b-multiselect-dropdown');
...
export const B2bShimmer = /*@__PURE__*/createReactComponent<JSX.B2bShimmer, HTMLB2bShimmerElement>('b2b-shimmer');
...
export const B2bTable = /*@__PURE__*/createReactComponent<JSX.B2bTable, HTMLB2bTableElement>('b2b-table');
export const B2bTableCell = /*@__PURE__*/createReactComponent<JSX.B2bTableCell, HTMLB2bTableCellElement>('b2b-table-cell');
...
export const B2bWizardStep = /*@__PURE__*/createReactComponent<JSX.B2bWizardStep, HTMLB2bWizardStepElement>('b2b-wizard-step');
