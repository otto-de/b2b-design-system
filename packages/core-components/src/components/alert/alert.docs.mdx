...
By default, the content inside the large alert is left-aligned. You can change this by setting the `align` attribute to `center`

#### Center aligned

<b2b-alert opened size="large" align="center" type="warning">An alert with centered content.</b2b-alert>
