...
<Canvas columns={3} withSource="open" withToolbar={false}>
  <Story id="components-interaction-button--story-010-secondary" />
</Canvas>
...
<Canvas withSource="close" withToolbar={false}>
  <Story id="components-interaction-button--story-020-primary" />
</Canvas>
...
<Canvas withSource="close" withToolbar={false}>
  <Story id="components-interaction-button--story-030-loading" />
</Canvas>
...
<Canvas withSource="close" withToolbar={false}>
  <Story id="components-interaction-button--story-070-disabled" />
</Canvas>
...
<Canvas columns={5} withSource="open" withToolbar={false} isColumn={false}>
  <Story id="components-interaction-button--story-040-icon-start" />
  <Story id="components-interaction-button--story-050-icon-end" />
  <Story id="components-interaction-button--story-055-icon-start-pali" />
</Canvas>
...
<Canvas columns={5} withSource="close" withToolbar={false} isColumn={false}>
  <Story id="components-interaction-button--story-060-icon-search" />
</Canvas>
