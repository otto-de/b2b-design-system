...
<Canvas of={DatePickerStories.DisableEvery} />
...
The width of the input field of the date picker in pixel. Minimum is 300, maximum is 600px. By default, this is 300px.
