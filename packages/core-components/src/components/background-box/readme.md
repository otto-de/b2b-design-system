...
| `borderTop`    | `border-top`    | Whether the box should have a top border. Per default, the border is enabled    | `"default" \| "none"` | `'default'` |
| `fixedWidth`   | `fixed-width`   | Fixes width to 1212px. Per default, it is false                                 | `boolean`             | `false`     |
