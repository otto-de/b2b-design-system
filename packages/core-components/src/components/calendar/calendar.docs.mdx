...
The B2B calendar component is interactive and provides option to select a particular date. You can hook into an event
that fires whenever the user selects a date from the calendar.
