...
<b2b-alert
  ...
  custom-icon="false">We are open source! Now you can install our libraries without any
authentication needed.<br /> Find more in our <a href="?path=/docs/updates--page">updates page.</a>
</b2b-alert>
