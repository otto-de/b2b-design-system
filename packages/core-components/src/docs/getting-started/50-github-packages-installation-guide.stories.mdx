...
Visit [npm](https://www.npmjs.com/package/@otto-de/b2b-core-components) or install our core components directly by running

```
npm i @otto-de/b2b-core-components @otto-de/b2b-tokens
```

That's it, now you're all set to use our components in your project.

---

## **_Beware! The guide below refers to our private package hosted on GitHub Actions which will soon be DEPRECATED_**
