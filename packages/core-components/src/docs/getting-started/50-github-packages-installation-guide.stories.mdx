...
To use the components, you need to load a CSS file and some JavaScript. The CSS file includes the fonts and the design tokens. In this case, there is no need to install the tokens package again.
