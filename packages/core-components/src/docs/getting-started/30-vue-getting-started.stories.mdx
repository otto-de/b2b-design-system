...
<br />
To use the components, you need to load a CSS file and some JavaScript. The CSS file
includes the fonts and the design tokens.
...
## How to use b2b-core-components in Nuxt 2
